            ...
            module.exports = async (availableRoutes, req, res) => {
                try {
                    ...
                    for (let k in availableRoutes) {
                        ...
                        match = true
                        req.params = availableRoutes[k].parser.getParam(
                            pathName
                        )
            ...
            module.exports = function (args, opts) {
                ...
                for (var i = 0; i < args.length; i++) {
                    ...
                    if (/^--.+=/.test(arg)) {
                        ...
                        if (
                            !flags.unknownFn ||
                            flags.unknownFn(arg) !== false
                        ) {
                            argv._.push(
                                flags.strings['_'] || !isNumber(arg)
                                    ? arg
                                    : Number(arg)
                            )
                        }
        ...
        /***/ 168: /***/ function (
            ...
            async function processDirectory(currPath, dir) {
                ...
                if (!fs.existsSync(pathToCheck)) {
                    throw new Error(
                        `Couldn't find initial directory:${pathToCheck}`
                    )
                }
...
*/
	...
	*/
        ...
        /***/ 854: /***/ function (__unusedmodule, exports) {
        ...
        /***/ 964: /***/ function (
            ...
            const ora = __webpack_require__(937)
            const clone = __webpack_require__(926)
            const config = __webpack_require__(164)
            const path = __webpack_require__(622)
            const { readdirSync, lstatSync } = __webpack_require__(747)
